 ...
 * 
 * Le WrapLayout est une classe similaire au FlowLayout � laquelle nous pouvons 
 * ajouter un JScrollPane sans qu'il y ait de probl�mes (contrairement au 
 * FlowLayout avec JScrollPane). Celle-ci g�re le retour � la ligne aux extr�mit�s du 
 * JPanel
 *
 */
